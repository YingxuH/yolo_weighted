...
class BaseTrainer:
    ...
    def _setup_train(self, rank, world_size):
        ...
        self.train_loader = self.get_weights_dataloader(self.trainset, batch_size=batch_size, rank=rank, mode="train")
        if rank in {0, -1}:
    ...
    def get_weights_dataloader(self, dataset_path, batch_size=16, rank=0):
        """
