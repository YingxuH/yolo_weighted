...
from ultralytics.yolo.utils import NUM_THREADS, TQDM_BAR_FORMAT
from ultralytics.yolo.data.utils import HELP_URL, IMG_FORMATS, LOCAL_RANK
...
class BaseDataset(Dataset):
    ...
    def __getitem__(self, index):
        print(123)
        return self.transforms(self.get_label_info(index)), self.weights[index]
